							...
							<div className="h-full w-full overflow-y-auto scrollbar-hide">
									...
									<div className="flex-1 flex flex-col justify-center space-y-3 w-full">
										...
										<div className="space-y-4 sm:space-y-6 pt-4">
											...
											<div className="flex gap-3 sm:gap-4">
												...
												<div>
													<p className="text-sm sm:text-base text-white leading-[150%]">
														No peer match within 30 seconds? Your intent routes automatically to DeepBook V3 for guaranteed fill.
													</p>
												</div>
											</div>
										</div>
								...
								<input type="number" id="amount" name="amount" placeholder="0.00" value={amount} onChange={e => setAmount(e.target.value)} className="w-full px-4 py-2.5 rounded-lg bg-[#001F63] border-0 text-white placeholder:text-white/50 focus:outline-none focus:ring-2 focus:ring-white/20 transition-all text-sm h-10" />
												...
												<div className="sm:w-32 w-full">
													<label htmlFor="company-size" className="block text-[10px] font-mono font-normal text-white mb-2 tracking-[0.5px] uppercase">MIN PRICE</label>
														...
														<div className="relative z-10 min-h-full flex flex-col items-center justify-center w-full max-w-[600px] mx-auto p-6 sm:p-10 lg:p-16 gap-6 text-center">
															...
															{intentResult.status === "matched" ? (
																...
																<>
																	...
																	<p className="text-white/70 text-base">No match found yet — your intent is queued. Routes to DeepBook V3 in 30 seconds if unmatched.</p>
																	<div className="w-full bg-white/10 rounded-xl p-5 text-left space-y-3">
															...
															<button onClick={() => { setIntentResult(null); setAmount(""); setMinPrice(""); setIsExpanded(false); }} className="px-8 py-2.5 rounded-full bg-white text-[#0041C1] font-medium hover:bg-white/90 transition-colors tracking-[-0.03em] h-10">
																Done
															</button>
														</div>
													</div>
